-- WCL Store Pending Types JSONB Hotfix
-- Date: 2026-06-13
--
-- Purpose:
--   Fix bo_update_store_pending_v1 so store_pending.types is written as JSONB.
--
-- Safety:
--   - Does not update any pending listings when this script is installed.
...
-- Verification:
-- Expected result: variable declaration contains "v_types jsonb".
select pg_get_functiondef(
  'public.bo_update_store_pending_v1(bigint,jsonb)'::regprocedure
