      ...
      Object.entries(byCountry)
        ...
        .forEach(([country, countryStores]) => {
          ...
          countryLine.innerHTML = `
            ${flag ? `<img src="${flag}" class="flag" style="width:18px;height:14px;border-radius:3px;margin-right:5px;">` : ""}
            ${country}
